...
# need to get library for importing JSON?
# library(“RJSONIO”) 
...
# addresses = paste0(addresses, ", California")

txt_addresses = txt_data$Address

ad1 = "2003 11th Street, Sacramento, CA 95818"
ad2 = "3008 Duchess Court, Rocklin, CA 95765"

geotest1 = geocode(ad1, output='all')
geotest2 = geocode(ad2, output='all')

gt_lat1 = format(geotest1$results[[1]]$geometry$location$lat, digits=20)
gt_lat2 = format(geotest2$results[[1]]$geometry$location$lat, digits=20)

format(geotest1$results[[1]]$geometry$location$lat, digits=20)
format(geotest1$results[[1]]$geometry$location$lat, digits=20)
